...
```{r, echo=FALSE}
shapiro.test(clouds_copy[['square_root_seeded']]-clouds_copy[['square_root_unseeded']])

```
shapiro test p-value is greater than 0.05 so we can't use this test to conclude if the data is normal or not.
